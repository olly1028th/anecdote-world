      ...
      {shareModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-end sm:items-center justify-center" onClick={() => setShareModalOpen(false)}>
          <div
            role="dialog"
            aria-modal="true"
            aria-label="Share My Journey"
            className="bg-[#F9F4E8] dark:bg-[#1a1208] w-full max-w-md rounded-t-2xl sm:rounded-2xl border-[3px] border-slate-900 sm:retro-shadow flex flex-col max-h-[75dvh] sm:max-h-[85dvh]"
            onClick={(e) => e.stopPropagation()}
          >
            {/* 헤더 — 고정 */}
            <div className="shrink-0 px-6 pt-5 pb-3 border-b border-slate-200 dark:border-[#4a3f35]">
