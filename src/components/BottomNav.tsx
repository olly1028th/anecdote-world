  ...
  return (
    <nav className="fixed bottom-0 w-full bg-[#F9F4E8] dark:bg-[#221910] border-t-2 border-[#f48c25]/20 pb-[env(safe-area-inset-bottom,32px)] pt-2 px-4 sm:px-6 z-50">
      <div className="flex justify-between items-center max-w-md mx-auto">
        ...
        {/* 타임라인 */}
        <Link to="/timeline" className={`flex flex-col items-center justify-center gap-0.5 no-underline min-w-[44px] min-h-[44px] px-1 ${isActive('/timeline') ? 'text-[#f48c25]' : 'text-slate-400'}`}>
